...
//show films block
// const siteFilmsView = new FilmsView();  //done
// render(SITE_MAIN, siteFilmsView, RenderPosition.BEFOREEND); //done

// const filmsListView = new FilmsListView(Boolean(filmsCount)); //done
// render(siteFilmsView, filmsListView, RenderPosition.BEFOREEND); //done

// const filmsListTopView = new FilmsListTopView();  //done
// render(siteFilmsView, filmsListTopView, RenderPosition.BEFOREEND);  //done

// const filmsListCommentedView = new FilmsListCommentedView();  //done
// render(siteFilmsView, filmsListCommentedView, RenderPosition.BEFOREEND);  //done
